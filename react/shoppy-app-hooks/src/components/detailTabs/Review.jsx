    ...
    return (
        <div className='review-list-item'>
            <div className='pdt_review_info'>
                <div className='product_review_info_left'>
                    <div className='pdt_review_option'>
                        ...
                        <p><span>사이즈 : 180cm</span></p>
                    </div>
                </div>
                <p className='product_reveiw_info_right'>
                    <em>da**********</em>
            ...
            <ul className='pdt_review_photo'>
                <li>
                    <img src="https://media.wconcept.co.kr/review/306388708/306388708_1758068044397.jpg?RS=300" alt="" />
                </li>
            </ul>
            <div className='pdt_review_detail'>
                <p className='pdt_review_text'>
                    사진보다 색이 연해서 더 맘에 드네요.
                    옷은 무겁습니다.
                    두꺼워서 따뜻하겠어요.
                </p>
            </div>
