 ...
 * - for..of 구문 (https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Statements/for...of)
...
// Number 클래스는 iterable object가 아니므로 for..of 사용 X
// console.clear();
const numbers2 = new Number(12345);
// for(const number of numbers2) console.log(number);   // 에러
